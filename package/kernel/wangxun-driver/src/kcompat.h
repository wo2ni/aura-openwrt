...
/*#define NGBE_SUPPORT_KYLIN*/			/*kylin to open*/
/*#define CONFIG_EULER_KERNEL */		/*EULER to open*/
/*#define CONFIG_UOS_KERNEL */			/*UOS	to open*/

/**88888888888888888888888888*/
#ifndef NGBE_STATIC_ITR
#define NGBE_STATIC_ITR 1		/* static itr configure */
#endif

#ifndef NGBE_LINK_RETRY
#define NGBE_LINK_RETRY 0		/* static itr configure */
#endif
...
#define UTS_UBUNTU_RELEASE_ABI 21
#else
#define UTS_UBUNTU_RELEASE_ABI 21
#endif
#endif
...
/* For Kylin:
 * support Kylin-4.0.2-SP2-17122218.j1-arm64 */
#ifdef UTS_KYLINOS_RELEASE_ABI
#ifndef UTS_UBUNTU_RELEASE_ABI
#if UTS_KYLINOS_RELEASE_ABI <= 20171215
#define UTS_UBUNTU_RELEASE_ABI 21
#else
#define UTS_UBUNTU_RELEASE_ABI 21
#endif
#endif /* !UTS_UBUNTU_RELEASE_ABI */
#endif /* UTS_KYLINOS_RELEASE_ABI */

/* NAPI enable/disable flags here */
#define NAPI

#define adapter_struct ngbe_adapter
#define adapter_q_vector ngbe_q_vector
...
#define CONFIG_NGBE_DISABLE_PACKET_SPLIT
#endif
...
#elif (defined(CONFIG_UOS_KERNEL) || defined(CONFIG_EULER_KERNEL) || defined(CONFIG_KYLIN_KERNEL))
...
#ifndef CONFIG_T1000_DISABLE_PACKET_SPLIT
#define CONFIG_T1000_DISABLE_PACKET_SPLIT 1
#endif
#ifndef CONFIG_TGB_DISABLE_PACKET_SPLIT
#define CONFIG_TGB_DISABLE_PACKET_SPLIT 1
#endif
#ifndef CONFIG_TGC_DISABLE_PACKET_SPLIT
#define CONFIG_TGC_DISABLE_PACKET_SPLIT 1
#endif
...
#endif /* WARN */
#undef HAVE_NGBE_DEBUG_FS
#undef HAVE_TGB_DEBUG_FS
#else /* < 2.6.27 */
#define ethtool_cmd_speed_set _kc_ethtool_cmd_speed_set
static inline void _kc_ethtool_cmd_speed_set(struct ethtool_cmd *ep,
					     __u32 speed)
...
#define HAVE_NGBE_DEBUG_FS
#define HAVE_TGB_DEBUG_FS
...
#undef ngbe_get_netdev_tc_txq
#define ngbe_get_netdev_tc_txq(dev, tc) (&netdev_extended(dev)->qos_data.tc_to_txq[tc])
#endif
/*****************************************************************************/
...
#define HAVE_NDO_SELECT_QUEUE_ACCEL_FALLBACK
#elif (defined(UTS_RELEASE) && LINUX_VERSION_CODE >= KERNEL_VERSION(3, 13, 0))
#define HAVE_NDO_SELECT_QUEUE_ACCEL_FALLBACK
#else
...
#endif
#if (SLE_VERSION_CODE && (SLE_VERSION_CODE == SLE_VERSION(12,3,0)))
#define HAVE_NOT_SUPPORTED_1000baseX_Full
#endif
...
#ifndef HAVE_DEFINE_FLOW_CORRELATION
struct flow_match {
...
void ngbe_flow_rule_match_basic(const struct flow_rule *rule,
			   struct flow_match_basic *out);
void ngbe_flow_rule_match_control(const struct flow_rule *rule,
			     struct flow_match_control *out);
void ngbe_flow_rule_match_eth_addrs(const struct flow_rule *rule,
			       struct flow_match_eth_addrs *out);
#ifndef HAVE_TC_FLOWER_VLAN_IN_TAGS
void ngbe_flow_rule_match_vlan(const struct flow_rule *rule,
			  struct flow_match_vlan *out);
#endif
void ngbe_flow_rule_match_ipv4_addrs(const struct flow_rule *rule,
				struct flow_match_ipv4_addrs *out);
void ngbe_flow_rule_match_ipv6_addrs(const struct flow_rule *rule,
				struct flow_match_ipv6_addrs *out);
void ngbe_flow_rule_match_ports(const struct flow_rule *rule,
			   struct flow_match_ports *out);
#ifdef HAVE_TC_FLOWER_ENC
void ngbe_flow_rule_match_enc_ports(const struct flow_rule *rule,
			       struct flow_match_ports *out);
void ngbe_flow_rule_match_enc_control(const struct flow_rule *rule,
				 struct flow_match_control *out);
void ngbe_flow_rule_match_enc_ipv4_addrs(const struct flow_rule *rule,
				    struct flow_match_ipv4_addrs *out);
void ngbe_flow_rule_match_enc_ipv6_addrs(const struct flow_rule *rule,
				    struct flow_match_ipv6_addrs *out);
void ngbe_flow_rule_match_enc_keyid(const struct flow_rule *rule,
...
#endif /* HAVE_DEFINE_FLOW_CORRELATION */
#endif /* HAVE_TC_SETUP_CLSFLOWER */
...
#ifndef HAVE_ETH_EXTENDED_HEADLEN
static inline u32
...
#endif /* HAVE_ETH_EXTENDED_HEADLEN */
...
#ifndef HAVE_DEFINE_SKB_FRAG_OFF
...
#ifndef HAVE_DEFINE_SKB_FRAG_ADD
...
#endif /* SLE_VERSION_CODE && SLE_VERSION_CODE >= SLES15SP4 */
